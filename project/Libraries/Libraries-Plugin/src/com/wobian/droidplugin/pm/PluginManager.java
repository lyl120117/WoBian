...
package com.wobian.droidplugin.pm;
...
import com.wobian.droidplugin.BuildConfig;
...
public class PluginManager implements ServiceConnection {
    ...
    public static final String ACTION_PACKAGE_ADDED = "com.wobian.droidplugin.PACKAGE_ADDED";
    public static final String ACTION_PACKAGE_REMOVED = "com.wobian.droidplugin.PACKAGE_REMOVED";
    public static final String ACTION_DROIDPLUGIN_INIT = "com.wobian.droidplugin.ACTION_DROIDPLUGIN_INIT";
    public static final String ACTION_MAINACTIVITY_ONCREATE = "com.wobian.droidplugin.ACTION_MAINACTIVITY_ONCREATE";
    public static final String ACTION_MAINACTIVITY_ONDESTORY = "com.wobian.droidplugin.ACTION_MAINACTIVITY_ONDESTORY";
    public static final String ACTION_SETTING = "com.wobian.droidplugin.ACTION_SETTING";
    public static final String ACTION_SHORTCUT_PROXY = "com.wobian.droidplugin.ACTION_SHORTCUT_PROXY";


    public static final String EXTRA_PID = "com.wobian.droidplugin.EXTRA_PID";
    public static final String EXTRA_PACKAGENAME = "com.wobian.droidplugin.EXTRA_EXTRA_PACKAGENAME";

    public static final String STUB_AUTHORITY_NAME = BuildConfig.AUTHORITY_NAME;
    public static final String EXTRA_APP_PERSISTENT = "com.wobian.droidplugin.EXTRA_APP_PERSISTENT";
    ...
    public void deleteApplicationCacheFiles(String packageName, final Object observer/*android.content.pm.IPackageDataObserver*/) throws RemoteException {
        try {
            if (mPluginManager != null && packageName != null) {
                mPluginManager.deleteApplicationCacheFiles(packageName, new com.wobian.droidplugin.pm.IPackageDataObserver.Stub() {
    ...
    public void clearApplicationUserData(String packageName, final Object observer/*android.content.pm.IPackageDataObserver*/) throws RemoteException {
        try {
            if (mPluginManager != null && packageName != null) {
                mPluginManager.clearApplicationUserData(packageName, new com.wobian.droidplugin.pm.IPackageDataObserver.Stub() {
