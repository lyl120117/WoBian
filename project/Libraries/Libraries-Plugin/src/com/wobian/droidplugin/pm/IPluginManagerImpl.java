...
import com.wobian.droidplugin.am.BaseActivityManagerService;
import com.wobian.droidplugin.am.MyActivityManagerService;
import com.wobian.droidplugin.core.PluginClassLoader;
import com.wobian.droidplugin.core.PluginDirHelper;
import com.wobian.droidplugin.pm.parser.IntentMatcher;
import com.wobian.droidplugin.pm.parser.PluginPackageParser;
import com.wobian.helper.Log;
import com.wobian.helper.Utils;
import com.wobian.helper.compat.NativeLibraryHelperCompat;
import com.wobian.helper.compat.PackageManagerCompat;
        ...
        try {
            ...
            if (pms != null && pms.requestedPermissions != null && pms.requestedPermissions.length > 0) {
                for (String requestedPermission : pms.requestedPermissions) {
                    android.util.Log.d(TAG, "loadHostRequestedPermission   requestedPermission="+requestedPermission);
            ...
            if ((flags & PackageManagerCompat.INSTALL_REPLACE_EXISTING) != 0) {
                ...
                if (pkgInfo != null && pkgInfo.requestedPermissions != null && pkgInfo.requestedPermissions.length > 0) {
                    for (String requestedPermission : pkgInfo.requestedPermissions) {
                        ...
                        android.util.Log.d(TAG, "##Permission %s"+requestedPermission);
