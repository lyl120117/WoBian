...
package com.wobian.droidplugin.hook.xhook;
...
public class SQLiteDatabaseHook extends Hook {
    ...
    private String tryReplacePath(String tarDir) {
        //mDataDir=/data/data/
        //mHostDataDir=/data/data/com.wobian/
        //mHostPkg=com.wobian
        //Old stat([/data/data/com.wobian/Plugin/com.qihoo.appstore/apk/base-1.apk])
        //New stat([/data/data/com.wobian/Plugin/com.wobian/data/com.wobian/Plugin/com.qihoo.appstore/apk/base-1.apk])
